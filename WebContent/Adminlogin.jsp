...
<title>Admin Login |FoodBytes</title>
        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="https://i.pinimg.com/736x/74/17/11/7417110f940bab19efdd81bcc3cca32f.jpg"
...
<!--                     <i class="fas fa-cubes fa-2x me-3" style="color: #ff6219;"></i> -->
                    <span class="h1 fw-bold mb-0">FoodBytes</span>
                  </div>
